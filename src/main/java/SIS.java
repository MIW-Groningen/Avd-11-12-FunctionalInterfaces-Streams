...
public class SIS {
    ...
    /**
     * SIS constructor that generates a SIS with random data
     *
     * @param nCourses                 number of courses in the SIS
     * @param nStudents                number of students in the SIS
     * @param nExams                   number of previous exams; these will be distributed randomly across courses and dates
     * @param averageRequiredECTS      Students will be given random Course requirements which collectively adhere to
     *                                 the specified average number of ECTS
     * @param averageExamParticipation Students will be given random Exam results
    ...
    /**
     * finds all Exams in the SIS that match a given filter criterium
     *
     * @param filter
     * @return
     */
    ...
    /**
     * Calculates the total study requirements per Student based on their Course requirements
     *
     * @return
     */
    ...
    /**
     * Calculates the total number of ects earned per Student, based on their Exam results
     *
     * @return
     */
    ...
    /**
     * Calculates the expected maximum participation of a future Exam based on current study results.
     * It counts per Exam all students that have the Course on their requirements,
     * but not yet passed an Exam of the Course
     *
     * @param filter
     * @return
     */
    ...
    /**
     * A builder helper class to compose a small SIS using method-chaining of builder methods
     */
    public static class Builder {
        ...
        /**
         * Builder method to add a course to the SIS being build
         *
         * @param course
         * @return
         */
        ...
        /**
         * Builder method to add a student to the SIS being build
         * Also adds the specified courses to the study requirements of the student
         * Non-existing course codes will also be added to the SIS, if needed
         *
         * @param student
         * @param courseCodes
         * @return
        ...
        /**
         * Builder method to add an Exam to the specified course in the SIS
        ...
        /**
         * Builder method to add an exam result to the SIS
         * If a specified Exam, Course or Student is missing, these will first be added
         *
         * @param dateString
         * @param courseCode
         * @param studentNr
